...
function __promptline_ps1 {
  ...
  __promptline_wrapper "$(git_sha)" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; is_prompt_empty=0; }
  __promptline_wrapper "$(git_stash_number)" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; is_prompt_empty=0; }
...
function __promptline_right_prompt {
  ...
  __promptline_wrapper "$(git_sha)" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; }
  __promptline_wrapper "$(git_stash_number)" "$slice_prefix" "$slice_suffix" && { slice_prefix="$slice_joiner"; }
